...
function planFromPaddlePriceId(priceId: string | undefined): PlanFromPrice | undefined {
  ...
  if (priceId === process.env.PADDLE_PRICE_PILOT) return { plan: 'pilot', maxClients: 50 }
  ...
  if (priceId === process.env.PADDLE_PRICE_WHITELABEL) return { plan: 'whitelabel', maxClients: 200 }
